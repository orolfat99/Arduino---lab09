...
LBLEService ledService("06050421-E8F2-537E-4F6C-D104768A1214");
LBLECharacteristicInt switchCharacteristic("06050421-E8F2-537E-4F6C-D104768A1214", LBLE_READ | LBLE_WRITE);
...
void setup() {
  ...
  advertisement.configAsConnectableDevice("john");

  // Configure our device's Generic Access Profile's device name
  // Ususally this is the same as the name in the advertisement data.
  LBLEPeripheral.setName("john");
